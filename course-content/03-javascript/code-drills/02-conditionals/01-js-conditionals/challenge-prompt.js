...
var characterTwoYearlyExpenses= 12 * characterTwoExpenses
...
// Else, console log `characterTwoName` prepended to the string " is a high roller!"
    ...
    console.logn(characterTwoName + "is a high roller")
}
...
if (characterOneProfession === "Web Developer" || characterTwoProfession === "Data Analyst"){
    console.log("Hey look! One of them is in the tech inductry")
}
