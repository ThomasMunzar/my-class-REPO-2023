...
app.use(express.static('public')); // everything in the public file will be available
// THEN in html you can reference that path 

//otherwise you make a path for EACH think you want to show
