...
var netflixQueue = {
  ...
  watchMovie: function(){ //replaced => to function. cannot use => with objects or used as methods
    this.queue.pop(); //THIS = netflixQueue.queue  so its a short cut essentially
  },
